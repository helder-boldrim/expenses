...
#          4.4 - Added the generation of a database view with the same query as the one generated by this script.
try:
	...
	for section in filesSet:
		...
		for i, row in df.iterrows(): 
			...
			print(f"{counter}/{affectedRows} rows were read/inserted for section", "{:<9}".format(itemSection), 
				"/ category", "{:<13}".format(itemCategory), "/ subcategory", itemSubcategory)
	...
	mycursor.execute(f"Create or Replace View EXPENSES_VW As \n{queryText}")
